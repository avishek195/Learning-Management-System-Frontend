...
const Signup = () => {
  ...
  const [previewImage, setPreviewImaeg] = useState("");
  ...
  const createNewAccount = async (event) => {
    ...
    if (
      ...
      toast.error(
        "At least a number , a sepcial character and [6-16] in length"
      );
      return;
    }
    if (
    ...
    if (signupData.fullname.length < 5) {
      toast.error("Iname must be atleast 5 character");
      return;
    }
